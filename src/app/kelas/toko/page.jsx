  ...
  return (
    <div className="max-w-3xl mx-auto text-black py-8 px-4">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold">Toko Gamifikasi</h1>
            ...
            >
              ...
              <div className="flex flex-col items-end min-w-[120px]">
                ...
                <button
                  ...
                  className={`px-5 py-2 rounded-lg bg-[#ffbb00] text-white font-semibold hover:bg-yellow-500 transition ${
                    buying === item.id ? "opacity-60 cursor-not-allowed" : ""
